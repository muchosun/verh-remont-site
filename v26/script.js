...
const tariffs = {
  cosmetic: {
    ...
    prefix: "от ",
    included: [
      "обновление стен, пола и других выбранных зон",
      "материалы для согласованного объёма работ",
      "точный перечень работ после осмотра квартиры",
      "смета, договор и понятный график этапов",
    ],
  },
  standard: {
    title: "Стандарт",
